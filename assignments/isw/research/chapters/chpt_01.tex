...
\begin{document}
    ...
    In the mind map \hyperlink{fig:mindmap_agribots}{\emph{Agricultural robots}} I show the most important points for more convenient access and reminding.
    ...
    \node{\hypertarget{fig:mindmap_agribots}{\textbf{\huge Agricultural robots}}}
        child { node {\textbf{Primary tasks}}
            ...
            child { node {\footnotesize Application of chemicals}}
        }
        ...
        child { node {\textbf{Motivation}}
            ...
            child { node {\footnotesize Lessen usage of chemicals}}
